        ...
        return (
            <Content >
                ...
                <Form model="maleQuestions" >
                    <Text>Do you use lubricants during sex?</Text>
                    <Control.Picker model=".lube" >
...
export default connect(mapStateToProps)(Lube);
