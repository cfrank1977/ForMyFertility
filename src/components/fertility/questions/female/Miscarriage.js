...
function handleSubmit({ navigation, fertilityQuestions, dispatch, }) {
    ...
    navigation.navigate("Ectopic")
}

const Miscarriage = ({ navigation, fertilityQuestions, dispatch }) => (
    <Content >
...
export default connect(({ nav, fertilityQuestions }) => ({ nav, fertilityQuestions }))(Miscarriage); 