...
function handleSubmit({ navigation, fertilityQuestions, dispatch, }) {
    ...
    navigation.navigate("FrozenEmbryos")
}

const Hormone = ({ navigation, fertilityQuestions, dispatch }) => (
    <Content >
        ...
        <Form model="fertilityQuestions" onSubmit={values => this.handleSubmit(values)}>
            <Text>Would you be using hormone-stimulating drugs with your IVF treatment?</Text>
...
export default connect(({ nav, fertilityQuestions }) => ({ nav, fertilityQuestions }))(Hormone); 