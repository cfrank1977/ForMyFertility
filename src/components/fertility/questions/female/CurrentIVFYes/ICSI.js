...
function handleSubmit({ navigation, fertilityQuestions, dispatch, }) {
    ...
    navigation.navigate("IVFCYCLES")
}

const ICSI = ({ navigation, fertilityQuestions, dispatch }) => (
    <Content >
        ...
        <Form model="fertilityQuestions" onSubmit={values => this.handleSubmit(values)}>
            <Text>Would you be undergoing intracytoplasmic sperm injection (ICSI)?</Text>
...
export default connect(({ nav, fertilityQuestions }) => ({ nav, fertilityQuestions }))(ICSI); 