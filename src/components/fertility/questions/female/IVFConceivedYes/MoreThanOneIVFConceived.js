...
const MoreThanOneIVFConceived = ({ navigation, fertilityQuestions, dispatch }) => (
    <Content >
...
export default connect(({ nav, fertilityQuestions }) => ({ nav, fertilityQuestions }))(MoreThanOneIVFConceived);